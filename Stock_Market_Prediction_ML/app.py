...
if stock:
    ...
    ax5.scatter(buy_signals, [predict[i] for i in buy_signals], color='green', marker='^', label='Buy Signal')
    ax5.scatter(sell_signals, [predict[i] for i in sell_signals], color='brown', marker='v', label='Sell Signal')
    ax5.set_xlabel('Time')
